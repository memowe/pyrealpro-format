...
class TestChord:
    ...
    def test_slash_chord(self) -> None:
        ...
        chord = Chord(
            ...
            bass=(NoteName.C, None),
        )
        assert chord.bass == (NoteName.C, None)

    def test_slash_chord_with_flat_bass(self) -> None:
        # C/Bb
        chord = Chord(
            NoteName.C,
            bass=(NoteName.B, Accidental.FLAT),
        )
        assert chord.bass == (NoteName.B, Accidental.FLAT)
...
class TestMarker:
    ...
    def test_kind_string_values(self) -> None:
        ...
        assert MarkerKind.SLASH.value == "p"
    ...
    def _make_song(self) -> Song:
        return Song(
            ...
            cells=(
                ...
                TextAnnotation("D.C. al Fine"),
                Marker(MarkerKind.FERMATA),
                Ending(1),
